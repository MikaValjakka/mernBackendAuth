...
eval("__webpack_require__.r(__webpack_exports__);\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './../config/config'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n/* harmony import */ var _express__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./express */ \"./server/express.js\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var mongoose__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(mongoose__WEBPACK_IMPORTED_MODULE_2__);\n\n\n\n\n//mongoose.Promise = global.Promise <- was mongoose 4.* based. After mongoose 5.* no need\n\nconst connectDB = async () => {\n  try {\n    await mongoose__WEBPACK_IMPORTED_MODULE_2___default().connect(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './../config/config'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {\n      //useNewUrlParser: true,\n      //seUnifiedTopology: true\n    });\n  } catch (err) {\n    console.log(\"Error while connecing to mongoDB by mongoose: \" + err);\n  }\n};\nconnectDB();\nmongoose__WEBPACK_IMPORTED_MODULE_2___default().connection.once(\"open\", () => {\n  console.log(`Mongoose connected to mongoDB at : ${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './../config/config'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}. Have nice day.`);\n});\n_express__WEBPACK_IMPORTED_MODULE_1__[\"default\"].listen(Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './../config/config'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), err => {\n  if (err) {\n    console.log(\"Error in connection:\" + err);\n  }\n  console.info(`Server started on port ${Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './../config/config'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }())}`);\n});\n\n//# sourceURL=webpack://mern_skeleton/./server/server.js?");
